  ...
  <div class="settings-menu" :class="{ 'glass-inner disable-hover': glass }">
    <div :class="['menu-content', { 'glass-inner disable-hover': glass }]">
            ...
            <section class="mb-6">
              ...
              <div class="d-flex align-center mb-4">
                <div class="mr-4 d-flex align-center">
                  ...
                  <v-chip :color="mavlinkStatusColor" size="small">
                    {{ mavlinkStatus }}
                  </v-chip>
                </div>

                <v-btn :color="mavlinkStatus === 'Connected' ? 'error' : 'success'" size="small"
      ...
      <div class="d-flex justify-end pa-2">
        <v-btn color="error" variant="text" @click="handleReset" class="mr-2">
          Reset
        </v-btn>
